      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-8 relative z-10">
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-end">
            ...
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Beloved Son of Mr. & Mrs. Damunugalla</p>
          </div>
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-start">
            ...
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Beloved Daughter of Mr. & Mrs. Wijekoon</p>
          </div>
