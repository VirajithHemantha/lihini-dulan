      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div className="relative w-48 h-48 mx-auto mb-16 group cursor-pointer flex items-center justify-center">
          ...
          <div className="absolute inset-[3rem] bg-white rounded-full shadow-[0_10px_30px_rgba(70,130,180,0.1)] flex flex-col items-center justify-center border-[4px] sm:border-[5px] border-brand-primary/30 group-hover:scale-110 group-hover:border-brand-primary/50 transition-all duration-700 ease-out z-10">
            ...
            <span className="font-display text-3xl text-brand-primary drop-shadow-sm leading-none tracking-tighter">L<span className="text-lg font-serif italic mx-0.5 text-stone-400">&</span>D</span>
          </div>
        ...
        <h2 className="text-4xl sm:text-5xl font-display text-stone-800 mb-6 tracking-tight drop-shadow-sm">Lihini & Dulan</h2>
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <div className="text-[9px] text-stone-400 tracking-widest uppercase font-medium">
            © 2027 Lihini & Dulan Wedding
          </div>
          <p className="text-stone-400 text-xs mt-2 font-sans tracking-wider">
            Want a beautiful wedding website like this? Create yours with <a target="_blank" rel="noreferrer" className="text-stone-500 hover:text-stone-800 underline transition-colors" href="https://wa.me/94707819074">invitemint</a>
          </p>
        </div>
      </div>
    </footer>
