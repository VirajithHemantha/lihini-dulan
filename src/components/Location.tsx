  ...
  return (
    <div className="max-w-[85rem] mx-auto px-6 relative py-12">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-0 mt-10">
        ...
        >
          <div className="bg-[#1A281E]/90 backdrop-blur-2xl p-10 sm:p-14 lg:p-16 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.3)] border border-brand-primary-light/30 lg:translate-x-12 relative overflow-hidden group">
